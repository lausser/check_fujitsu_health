...
define service {
  ...
  check_command                 check_fujitsu_health!cpu-load!80%%!90%%
}
EOEO
  printf <<'EOEO', $self->opts->hostname();
define service {
  ...
  check_command                 check_fujitsu_health!memory-usage!80%%!90%%
}
EOEO
  printf <<'EOEO', $self->opts->hostname();
define service {
  ...
  check_command                 check_fujitsu_health!interface-usage!$VALUE1$!$VALUE2$
